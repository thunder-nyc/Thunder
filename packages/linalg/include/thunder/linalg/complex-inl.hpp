...
#ifndef THUNDER_LINALG_COMPLEX_INL_HPP_
#define THUNDER_LINALG_COMPLEX_INL_HPP_
...
const Tensor< Storage< ::std::complex< D >, A > >& rotm(
  ...
  throw domain_error("rotm is undefined for complex tensors.");
}
...
#endif  // THUNDER_LINALG_COMPLEX_INL_HPP_
