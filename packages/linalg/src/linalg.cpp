...
template Linalg< DoubleTensor >::Linalg();
template Linalg< FloatTensor >::Linalg();
template Linalg< DoubleComplexTensor >::Linalg();
template Linalg< FloatComplexTensor >::Linalg();
